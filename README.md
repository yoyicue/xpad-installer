...
The v0.2.7 anchor uses versionCode 2 so a repair of already-persisted
...
This produces `dist/xpad-installer-v0.2.7-android-arm64.zip`. The archive
...
the same locked `xpad-install` v0.2.7 engine:

```shell
make windows-toolkit-package
```

This produces `dist/xpad-safe-install-toolkit-v2.7.0.zip`. The archive includes
